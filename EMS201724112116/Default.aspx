<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EMS201724112116.Default" %>
               ...
               <div class ="col">
                <div class="auto-style1">
                    <div class="card-header bg-info text-center">
                        首页&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:LinkButton ID="LinkButton2" runat="server" ForeColor="Black" OnClick="LinkButton2_Click">部门管理</asp:LinkButton>
