<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="EMS201724112116.Login" %>
            ...
            <div class="row">
               <div class ="col">
                <div class="auto-style1">
                    <div class="card-header bg-info text-center">设备保管与查询系统登录</div>
                    <div class="card-body text-center">
                        ...
                        <p>
                            <asp:Button ID="Button1" runat="server" Text="登 录" class="btn btn-success" OnClick="Button1_Click1" Width="296px" />
